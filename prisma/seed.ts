      ...
      data: [
        {
          ...
          assessment: "4.5",
          date: "3 Dias Atrás",
          text: "Comprei meu produto e fiquei muito satisfeita com o atendimento. Recebi todo o suporte que precisava e meu pedido chegou no prazo certinho. Já recomendei para minhas amigas!",
          imageUrl: "/uifaces-popular-image(5).webp",
        },
        {
          clientName: "Juliano Santos",
          assessment: "5.0",
          date: "2 Dias Atrás",
          text: "A experiência de compra foi incrível! Desde o site super intuitivo até a entrega super rápida, fiquei impressionado com a qualidade do produto. Com certeza vou comprar novamente!",
          imageUrl: "/uifaces-popular-image.webp",
        },
        {
          clientName: "Carlos Souza",
          assessment: "3.8",
          date: "9 Dias Atrás",
          text: "Eu sou muito exigente quando se trata de compras online, mas fiquei encantado com a transparência e a qualidade do serviço. A entrega foi super eficiente e o produto superou minhas expectativas.",
          imageUrl: "/uifaces-popular-image(1).webp",
        },
        {
          clientName: "Patrícia Lima",
          assessment: "4.7",
          date: "12 Dias Atrás",
          text: "Estou muito feliz com minha compra. O processo foi rápido e o produto chegou em perfeito estado. A única sugestão seria melhorar o processo de rastreamento do pedido, mas, fora isso, tudo ótimo!",
          imageUrl: "/uifaces-popular-image(4).webp",
        },
        {
          clientName: "Roberta Fernandes",
          assessment: "5.0",
          date: "1 Dia Atrás",
          text: "Eu nunca tive problemas ao comprar neste site. O atendimento é sempre excelente, e os produtos são sempre de alta qualidade. Sinto-me segura e confiante em todas as minhas compras.",
          imageUrl: "/uifaces-popular-image(6).webp",
        },
        {
          clientName: "Felipe Costa",
          assessment: "4.5",
          date: "Ontem",
          text: "A experiência de compra foi boa, mas a entrega demorou um pouco mais do que eu esperava. No entanto, o produto chegou bem embalado e em excelente estado. Com certeza farei novas compras!",
          imageUrl: "/uifaces-popular-image(2).webp",
        },
        {
          clientName: "Gabriel Ribeiro",
          assessment: "4.0",
          date: "14 Dias Atrás",
          text: "Fiquei impressionado com o nível de cuidado que a equipe teve durante todo o processo de compra. Desde o atendimento até a entrega, tudo foi perfeito. Muito feliz com meu produto!",
          imageUrl: "/uifaces-popular-image(3).webp",
        },
      ],
    });
