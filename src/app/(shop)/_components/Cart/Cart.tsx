...
const Cart = () => {
  ...
  return (
    <Sheet>
      ...
      <SheetContent
        className="bg-[#131313] border-none rounded-tr-3xl rounded-tl-3xl h-[30rem] sm:h-[35rem] text-secondaryColor px-5 sm:px-8 sm:py-3 py-2 flex flex-col"
        side={"bottom"}
      ...
      >
        ...
        <div className="max-h-[13rem] sm:max-h-[18rem] overflow-y-scroll w-full flex flex-col sm:gap-2">
