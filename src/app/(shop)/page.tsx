  ...
  return (
    <main>
      <div className="px-5 sm:px-8">
        ...
        <Header />
        <section className="flex flex-col text-center justify-center items-center mt-5">
          <h3 className="text-gray-400 text-md sm:text-xl" data-aos="fade-up">
            Confira nossas ofertas da semana!
          </h3>
          <h1
            className="text-secondaryColor text-2xl sm:text-3xl"
            data-aos-delay="200"
            data-aos="fade-up"
          >
          ...
          <h2
            className="text-gradient text-xl sm:text-2xl"
            data-aos-delay="300"
            data-aos="fade-up"
          >
          ...
          <a
            className="bg-gradient my-10 py-2 rounded-md w-[80%] sm:w-[17rem] sm:py-3 text-white hover:bg-primaryColor"
            href="#catalog"
            data-aos-delay="400"
            data-aos="zoom-in"
          >
